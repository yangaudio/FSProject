...
namespace  MoreMountains.Feedbacks
{
	...
	public class MMFeedbacksEvents
	{
        ...
        public bool OnInitedIsNull { get; protected set; }
        ...
        public virtual void TriggerOnInited(MMFeedbacks source)
        {
            if (!OnInitedIsNull && TriggerUnityEvents)
            {
                OnInited.Invoke();
            }
            ...
            if (TriggerMMFeedbacksEvents)
            {
                ...
                Debug.LogError("Oninited 没有 MMF的events，需要添加");
            }
        }
        /// <summary>
        /// Fires Play events if needed
